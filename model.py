...
class RVAE(nn.Module):
    # Length of each part in the chord one-hot representation
    N_PITCH = 12
    N_MAIN_QUALITY = 3
    N_EXTRA_QUALITY = 3
    ...
    def encode(self, input_sequence, sorted_lengths, batch_size):
    ...
    def decode(self, z, input_sequence, sorted_lengths, sorted_idx, batch_size, use_dropout=False):
        ...
        if self.chord_dropout_rate > 0 and use_dropout:
            ...
            decoder_input_sequence[prob < self.chord_dropout_rate] = self.no_chords
    ...
    def sample(self,mean,logv,batch_size):
    ...
    def forward(self, input_sequence, length):
        ...
        recons = self.decode(z, input_sequence, sorted_lengths, sorted_idx, batch_size)

        return recons, mean, logv, z

    def inference(self, n=4, z=None):
        """ Inference from a latent space, used for generation
        """
        if z is None:
            batch_size = n
            if torch.cuda.is_available():
